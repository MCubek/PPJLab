...
public class Naredba implements Action {
    ...
    public void checkProduction(SemanticProduction production, Scope scope) {
        //Nezavrˇsni znak <naredba> generira blokove (<slozena_naredba>) i razlicite vrste jednostavnih naredbi (<izraz_naredba>, <naredba_grananja>, <naredba_petlje> i <naredba_skoka>).
